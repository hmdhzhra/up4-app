...
<div class="modal fade" id="modal-upload{{$pengujian->id}}">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form action="{{route('bagitugas.surat_tugas', $pengujian->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                {{ method_field('POST') }}
                      ...
                      <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="surat_tugas" name="surat_tugas">
                                    <label class="custom-file-label" for="surat_tugas">Choose file</label>
                                </div>
